...
A) O código avalia a expressão booleana, imprime `true`, calcula o produto dos números na lista e imprime o resultado no console. ***Certo ✅***
...
A) Ambas as funções exibirão: 'Seu crédito foi aprovado. Saldo disponível: 400.' ***Certo ✅***
